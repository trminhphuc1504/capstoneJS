...
document.getElementById('formSP').onsubmit = async (ev)=>{
    try{
        ...
        isValid &= validation.required(sp.price,"Vui lòng nhập giá sản phẩm",'invalidPrice') && validation.isNumber(sp.price,'Giá sản phẩm phải là số')
        ...
        isValid &= validation.required(sp.img,"Vui lòng nhập thông tin hình ảnh",'invalidImg') && validation.isUrl(sp.img,'')
